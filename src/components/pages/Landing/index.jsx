  ...
  return (
    <div className='flex flex-col mt-20 w-full'>
      ...
      <div className='flex flex-row justify-center mt-10 gap-6'>
        ...
        <button onClick={downloadCSV} className='px-3 py-1.5 bg-gray-300 text-white font-semibold rounded-none hover:bg-gray-400 transition'>
          Download The Data
        </button>
      </div>

      <div className='flex flex-col lg:flex-row justify-center items-center mt-16 w-full px-10 gap-32 max-w-[1400px] mx-auto'>
        <img src={paperStack} className='w-[700px] max-h-80 rounded-xl object-cover' />
        <h2 className='text-xl lg:text-xl leading-relaxed text-left max-w-xl'>
          ...
          the USCIS Asylum Office, which we received through a Freedom of Information Act request. You can search for information on asylum grant rates by year,
          nationality, and asylum office, visualize the data with charts and heat maps, and download the data set.
        </h2>
      </div>

      <h2 className='text-5xl mt-30'>Systemic Disparity Insights</h2>
      ...
      <div className='flex flex-row justify-between items-start w-full px-12 mt-16'>
        <div className='flex flex-col w-96 text-center'>
          ...
          <h2 className='text-lg leading-relaxed'>
            By the end of the Trump administration, the average asylum office grant rate had fallen 36% from an average of 44 percent in fiscal year 2016 to 28
        ...
        <div className='flex flex-col w-96 text-center'>
          ...
          <h2 className='text-lg leading-relaxed'>The New York asylum office grant rate dropped to 5 percent in fiscal year 2020.</h2>
        </div>
      ...
      <div className='mt-20 mb-20'>
        <a href='https://humanrightsfirst.org/' target='_blank' rel='noopener noreferrer'>
          <button
            className='bg-[#6B705C] text-white px-4 py-2 text-base 
       rounded-none border border-[#6B705C] hover:bg-[#5A5F4C] transition'
          >
            Read More
          </button>
        </a>
        <div className='mt-20 text-lg text-black cursor-pointer hover:text-gray-900' onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          Back To Top ^
        </div>
      </div>
    </div>
